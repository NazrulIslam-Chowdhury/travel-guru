                ...
                <section className="sm:translate-y-[47%] translate-y-[15%] bg-cyan-400  text-gray-50 mx-5  rounded py-6">
                    <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
                        <div className="py-6 md:py-0 md:px-6">
                            ...
                            <p className="pt-2 pb-4 font1">Fill in the form to start a conversation</p>
                            <div className="space-y-4">
                                <p className="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 mr-2 sm:mr-6">
                                        <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd"></path>
                                    </svg>
                                    <span className='font1'>Fake address, 9999 City</span>
                                </p>
                                <p className="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 mr-2 sm:mr-6">
                                        <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"></path>
                                    </svg>
                                    <span className='font1'>123456789</span>
                                </p>
                                <p className="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 mr-2 sm:mr-6">
                                    ...
                                    <span className='font1'>contact@business.com</span>
                                </p>
                            </div>
                        </div>
                        <form novalidate="" className="flex flex-col py-6 space-y-6 md:py-0 md:px-6 ng-untouched ng-pristine ng-valid">
                            <label className="block">
                                <span className="mb-1 font1">Full name</span>
                                <input type="text"
                                    placeholder="Name"
                                    className="block w-full p-3 text-gray-400 rounded-md shadow-sm focus:ring focus:ring-opacity-75 focus:ring-violet-400 bg-white placeholder:text-gray-400 font1 placeholder:font1" />
                            </label>
                            <label className="block">
                                <span className="mb-1 font1">Email address</span>
                                <input
                                    type="email"
                                    placeholder="Email"
                                    className="block w-full p-3 text-gray-400 rounded-md shadow-sm focus:ring focus:ring-opacity-75 focus:ring-violet-400 bg-white placeholder:text-gray-400 font1 placeholder:font1" />
