import spain from "../images/places/spain.jpg";
import taiwan from "../images/places/Taiwan.jpg";
import bali from "../images/places/bali.jpg";

import valencia from "../images/places/valencia.jpg";
import madrid from "../images/places/madrid.jpg";
import barcelona from "../images/places/barcelona.jpg";

import tainan from "../images/places/tainan.jpg";
import taipei from "../images/places/taipei.jpg";
import kaohsiung from "../images/places/kaoshiung.jpg";
        ...
        "locations": [
            {
                ...
                "image": madrid,
                "price": "1100",
                "details": "Madrid (/məˈdrɪd/ mə-DRID, Spanish: [maˈðɾið])[n. 1] is the capital and most populous city of Spain. The city has almost 3.6 million[7] inhabitants and a metropolitan area population of approximately 6.7 million. It is the second-largest city in the European Union (EU), and its monocentric metropolitan area is the second-largest in the EU.[8][9][10] The municipality covers 604.3 km2 (233.3 sq mi) geographical area",
                "rating": "4.2 Good"
            },
            {
                "id": "02",
                ...
                "image": valencia,
                "price": "1000",
                "details": "Valencia (Valencian: València or Valéncia) is the capital of the autonomous community of Valencia and the third-most populated municipality in Spain, with 791,413 inhabitants. It is the capital of the province of the same name. The wider urban area comprising the neighbouring municipalities has a population of around 1.6 million,[3][5] constituting one of the major urban areas on the European side of the Mediterranean Sea. It is located on the banks of the Turia, on the east coast of the Iberian Peninsula at the Gulf of Valencia, north of the Albufera lagoon.",
                "rating": "4.0 Good"
            },
            {
                "id": "03",
                ...
                "image": barcelona,
                "price": "1100",
                "details": "Barcelona (/ˌbɑːrsəˈloʊnə/ (listen) BAR-sə-LOH-nə, Catalan: [bəɾsəˈlonə] (listen), Spanish: [baɾθeˈlona]) is a city on the coast of northeastern Spain. It is the capital and largest city of the autonomous community of Catalonia, as well as the second most populous municipality of Spain. With a population of 1.6 million within city limits,[7] its urban area extends to numerous neighbouring municipalities within the Province of Barcelona and is home to around 4.8 million people,[3] making it the fifth most populous urban area in the European Union after Paris, the Ruhr area, Madrid, and Milan.[3] It is one of the largest metropolises on the Mediterranean Sea, located on the coast between the mouths of the rivers Llobregat and Besòs, and bounded to the west by the Serra de Collserola mountain range.",
                "rating": "4.8 Superb"
            },
        ]
    },
    {
        ...
        "locations": [
            ...
            },
            {
                ...
                "image": kaohsiung,
                "price": "999",
                "details": "Kaohsiung (Mandarin Chinese: [káʊɕjʊ̌ŋ] (listen); Wade–Giles: Kao¹-hsiung²; Pinyin: Gāoxióng), officially Kaohsiung City[I], is a special municipality located in southern Taiwan. It ranges from the coastal urban center to the rural Yushan Range with an area of 2,952 km2 (1,140 sq mi). Kaohsiung City has a population of approximately 2.73 million people as of March 2023 and is Taiwan's third most populous city and largest city in southern Taiwan.[4]Since founding in the 17th century, Kaohsiung has grown from a small trading village into the political and economic centre of southern Taiwan, with key industries such as manufacturing, steel-making, oil refining, freight transport and shipbuilding. It is classified as a 'Gamma -' level global city by the Globalization and World Cities Research Network,[5] with some of the most prominent infrastructures in Taiwan. Kaohsiung is of strategic importance to the nation as the city is the main port city of Taiwan; the Port of Kaohsiung is the largest and busiest harbor in Taiwan and more than 67% of the nation's exports and imports container throughput goes through Kaohsiung.[6] Kaohsiung International Airport is the second busiest airport in number of passengers. The city is well-connected to other major cities by high speed and conventional rail, as well as several national freeways. It also hosts the Republic of China Navy fleet headquarters and its naval academy. More recent public works such as Pier-2 Art Center, National Kaohsiung Center for the Arts and Kaohsiung Music Center have been aimed at growing the tourism and cultural industries of the city.",
                "rating": "4.0 Good"
            },
            {
                "id": "03",
        ...
        "locations": [
            {
                ...
                "image": ubud,
                "price": "888",
                "details": "Ubud is a town on the Indonesian island of Bali in Ubud District, located amongst rice paddies and steep ravines in the central foothills of the Gianyar regency. Promoted as an arts and culture centre, it has developed a large tourism industry.[2] It forms a northern part of the Greater Denpasar metropolitan area (known as Sarbagita).Ubud, often mistaken for a small city, is an administrative district (kecamatan) with a population of 74,800 (as of the 2020 Census)[1] in an area of 42.38 km2. The central area of Ubud desa (village) has a population of 11,971 and an area of 6.76 km2,[3] and receives more than three million foreign tourists each year.[4] The area surrounding the town is made up of small farms, rice paddies, agroforestry plantations, and tourist accommodations. As of 2018, more tourists visited Ubud than Denpasar to the south.[5]",
                "rating": "4.8 Superb"
            },
            {
                "id": "02",
